...
#[allfeat_contracts::implementation(AFT34, AFT34Burnable, AFT34Mintable, AFT34Enumerable, AFT34URIStorage, AFT34ALBUMStorage)]
...
pub mod my_aft38 {
    ...
    // #[overrider(AFT34Mintable)]
    // #[openbrush::modifiers(only_owner)]
    // fn mint(&mut self, account: AccountId, id: Id) -> Result<(), AFT34Error> {
    //     aft34::InternalImpl::_mint_to(self, account, id)
    // }
    ...
    impl Contract {
        ...
        #[ink(message, payable)]
        pub fn mint(&mut self, account: AccountId, id: Id) -> Result<(), AFT34Error> {
            if Self::env().transferred_value() != 1_000_000_000_000_000_000 {
                return Err(AFT34Error::Custom(String::from("BadMintValue")));
            }
            self.mint(account, id)
         
          //  allfeat_contracts::aft34::Internal::mint(&mut self, account, id)           
        }
